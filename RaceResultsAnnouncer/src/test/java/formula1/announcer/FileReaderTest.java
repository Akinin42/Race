...
import formula1.resultscounter.NoFileException;
...
class FileReaderTest {
    ...
    @Test
    void read_ShouldReturnListStringsFromFile_WhenInputExistingFile() throws NoFileException, IOException {
    ...
    @Test
    void read_ShouldReturnListStringsFromFile_WhenInputSomeArticle() throws NoFileException, IOException {
    ...
    @Test
    void read_ShouldReturnEmptyList_WhenInputEmptyFile() throws NoFileException, IOException {
        String expected = "[]";

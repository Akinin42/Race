...
public class RaceLauncher {
    ...
    private static final String START_TIMES_FILE = "start.log";
    private static final String FINISH_TIMES_FILE = "end.log";
    ...
    public static void main(String[] args) {
        ...
        List<String> contentStartLines = reader.read(START_TIMES_FILE);
        List<String> contentFinishLines = reader.read(FINISH_TIMES_FILE);
